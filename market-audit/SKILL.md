...
6. **Translate ALL technical terms.** "Your website doesn't have cookie consent" NOT "No PECR-compliant CMP detected". If you must use a technical term, follow it immediately with a plain-English explanation in parentheses.
...
## Executive Summary
[3-5 paragraphs in plain English. Lead with what the score means in £/$ terms. Name the biggest strength with evidence. Name the biggest gap and what it costs them. List top 3 actions — each naming who should do it. End with estimated revenue impact.]

## Score Breakdown
[Table with all 6 categories, scores, weights, weighted scores, key findings]

## 🔴 Fix Immediately — Costing You Money Right Now
[3-5 items actively losing revenue. Each: plain-English problem → what it costs → "Ask your [role] to [action] — [time estimate]"]

## 🟠 Fix This Month — You're Missing Opportunities
[5-8 items where money is being left on the table. Same format: problem → cost → who fixes it → how long.]

## 🟡 Plan for Next Quarter — Worth Doing, Not Urgent
[2-5 longer-term improvements with business case. Name who leads each initiative.]

## Detailed Analysis by Category
[Full findings per category. Every finding title is a business impact statement. Translate all technical terms. Track confidence with HTML comments only: <!-- Confirmed -->]

## Competitor Comparison
[Table if competitors researched]

## Revenue Impact Summary
[Table: What to do | Who does it | Monthly £ impact | Confidence | Timeline]

## Next Steps
[Top 3 actions — each names who does it and the expected result]
...
- [ ] 🟡 Plan for Next Quarter (2-5 items)
