...
The production engine handles full audits natively. It reads all markdown reports from the directory automatically.
...
generate(
    ...
    output_path="./outputs/{domain}/FULL-AUDIT-REPORT.pdf",
    selected_suites=["Marketing", "Technical", "GEO", "Security", "Privacy", "Reputation", "Employer Brand", "AI Readiness"]
)
```
...
generate(
    directory="./outputs/{domain}",
    output_path="./outputs/{domain}/PARTIAL-AUDIT.pdf",
...
Suite numbers: 1=Marketing, 2=Technical, 3=GEO, 4=Security, 5=Privacy, 6=Reputation, 7=Employer Brand, 8=AI Readiness
