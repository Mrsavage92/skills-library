...
| `/market gbp <business>` | Google Business Profile audit and optimisation | GBP-AUDIT.md |
| `/market reviews <url>` | Review management strategy and response templates | REVIEW-STRATEGY.md |
