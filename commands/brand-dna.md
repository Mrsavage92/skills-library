Conduct a full brand reverse-engineering to produce a Brand DNA Document for use with AI image generation prompts (Nano Banana 2 / Higgsfield workflow).

INPUT VARIABLES (ask if not provided):
- Target Brand Name
- Target URL

---

Act as a Senior Brand Strategist conducting a full reverse-engineering of the target brand's visual and verbal identity. Create a comprehensive Brand DNA document that will be used to write highly specific AI image generation prompts. Every detail matters because the output will be fed into an image model that needs exact specifications.
...
Once complete, run `/ad-creative` to generate filled Nano Banana 2 prompts for a specific product using this Brand DNA.
