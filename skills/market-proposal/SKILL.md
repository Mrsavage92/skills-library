...
### Step 0: Auto-Import Audit Data (if available)

Before gathering any inputs, check for existing audit data in the working directory:

```
Check for: MARKETING-AUDIT.md
```

**If MARKETING-AUDIT.md exists**, auto-extract:
- Business name, URL, business type
- Overall score and all 6 category scores
- Top 3 strengths (from executive summary)
- Top 3 opportunities (from recommendations)
- Revenue impact estimates
- Competitor names and comparison data

Pre-populate the proposal with this data. Tell the user: "I found your audit data for [Business Name] and have pre-loaded it into the proposal. I just need a few more details to complete it."

**If no audit exists**, proceed with Step 1 below.

**Australian/local business defaults:** When proposing to Australian local businesses, use AUD currency, Australian English spelling (optimise, analyse, colour), GST disclaimers, and reference Australian platforms (Google Business Profile, OpenTable AU, TripAdvisor AU). Default minimum engagement to 3 months.
